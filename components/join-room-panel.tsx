...
export function JoinRoomPanel({ roomId }: { roomId: string }) {
  ...
  return (
    <div className="parchment poster-border w-full max-w-lg p-5 sm:p-7">
      <p className="text-xs font-black uppercase text-ink/60">Room code</p>
      ...
      <p className="mt-3 text-sm font-black uppercase leading-relaxed text-ink/75">
        You are signed in. Join this game as Player Two with the Ledger credential attached to this browser session.
      </p>
      <div className="mt-5">
