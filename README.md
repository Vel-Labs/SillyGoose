...
- `New Game` room creation with a shareable room code and Player Two join URL.
...
7. Give Player Two the room code or `/join/<room-code>` path shown on the game page.
